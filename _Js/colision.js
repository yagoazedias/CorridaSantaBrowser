var Colision = function()
{
	...
	this.update = function()
	{
		if(screenGame.GameScene === "Scene_Game")
		{
			...
			{bonus.x = 3000; bonus.y = 200 + Math.floor(Math.random() * (graphics.canvas.height - 300)); bonus.image.src = bonus.radomImage[Math.floor(Math.random() * (bonus.radomImage.length))];} 
			
			console.log(bonus.radomImage.length);
		}
	}
}
