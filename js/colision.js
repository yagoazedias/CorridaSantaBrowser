    ...
    {	
		if(screenGame.GameScene === "Scene_Game")
		{
                ...
                && ((player.y < arrow1.y - 10) && (player.y > arrow1.y - player.h + 30)) && player.life >= 1)
		    {
                arrow1.x = 1000; 
                arrow1.y = player.y; 
                graphics.ctx.drawImage(this.hit, 0, 0);
                player.life--;
            }
		    ...
		    { 
                arrow2.x = 1000; 
                arrow2.y = 200 + Math.floor(Math.random() * (graphics.canvas.height - 300)); 
                graphics.ctx.drawImage(this.hit, 0, 0); 
                player.life--; 
            }
		    ...
		    { 
                arrow3.x = 1000; 
                arrow3.y = 200 + Math.floor(Math.random() * (graphics.canvas.height - 300)); 
                graphics.ctx.drawImage(this.hit, 0, 0); 
                player.life--; 
            }
		    ...
		    { 
                arrow4.x = 1000; 
                arrow4.y = 200 + Math.floor(Math.random() * (graphics.canvas.height - 300));
                graphics.ctx.drawImage(this.hit, 0, 0); 
                player.life--; 
            }
